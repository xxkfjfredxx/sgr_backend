    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('incident_type', models.CharField(choices=[('Accidente', 'Accidente de Trabajo'), ('Incidente', 'Incidente')], db_index=True, default='Accidente', max_length=20)),
                ('date', models.DateField(db_index=True)),
                ('location', models.CharField(max_length=150)),
                ('description', models.TextField()),
                ('injury_type', models.CharField(blank=True, max_length=100)),
                ('severity', models.CharField(choices=[('Leve', 'Leve'), ('Grave', 'Grave'), ('Mortal', 'Mortal')], db_index=True, default='Leve', max_length=30)),
