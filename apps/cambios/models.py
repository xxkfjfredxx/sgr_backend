...
class ChangeRequest(AuditMixin, models.Model):
    ...
    created_at    = models.DateTimeField(auto_now_add=True)   # opcional; AuditMixin ya lleva created_at
...
class ChangeEvaluation(AuditMixin, models.Model):
    change_request     = models.OneToOneField(ChangeRequest, on_delete=models.CASCADE, related_name="evaluation")
...
class ChangeImplementation(AuditMixin, models.Model):
    change_request     = models.OneToOneField(ChangeRequest, on_delete=models.CASCADE, related_name="implementation")
