    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('responsible', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='objectives', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='SSTGoal',
            fields=[
                ...
                ('objective', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='goals', to='objectives.sstobjective')),
            ],
        ),
    ]
