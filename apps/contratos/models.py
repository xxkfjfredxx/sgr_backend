...
class Contract(AuditMixin, models.Model):
    ...
    employee       = models.ForeignKey(Employee,      on_delete=models.CASCADE, related_name="contracts", null=True, blank=True)
    contractor     = models.ForeignKey(ContractorCompany, on_delete=models.SET_NULL, null=True, blank=True)
