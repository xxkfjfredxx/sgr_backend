...
from apps.catalogos.models import WorkArea  # Puedes asociar a áreas o procesos

class LegalRequirement(models.Model):
    name = models.CharField(max_length=200)
    description = models.TextField()
    area = models.ForeignKey(WorkArea, on_delete=models.SET_NULL, null=True, blank=True, help_text="Área o proceso relacionado")
